...
Download the vmware installer from the official site:

```
https://support.broadcom.com/group/ecx/productdownloads?subfamily=VMware%20Workstation%20Pro&freeDownloads=true
```

## 2. Press on create a new machine
...
All default settings will be fine for the PandoraBox installation, just take note the recommende specs to run it.

## 4. Let PandoraBox do its magic
